...
inline ::Protocol::ObjectInfo* S_GAME_START::mutable_player(int index) {
...
inline const ::Protocol::ObjectInfo& S_GAME_START::_internal_player(int index) const {
  return _impl_.player_.Get(index);
}
inline const ::Protocol::ObjectInfo& S_GAME_START::player(int index) const {
  // @@protoc_insertion_point(field_get:Protocol.S_GAME_START.player)
  return _internal_player(index);
}
inline ::Protocol::ObjectInfo* S_GAME_START::_internal_add_player() {
  return _impl_.player_.Add();
}
inline ::Protocol::ObjectInfo* S_GAME_START::add_player() {
  ::Protocol::ObjectInfo* _add = _internal_add_player();
