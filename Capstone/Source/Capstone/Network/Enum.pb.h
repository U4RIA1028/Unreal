...
namespace Protocol {
    ...
    constexpr INGAME INGAME_MIN = ENTER_GAME;
    constexpr INGAME INGAME_MAX = PICK_UP_ITEM;
    ...
    constexpr MoveType MoveType_MIN = MOVE_NONE;
    constexpr MoveType MoveType_MAX = MOVE_JUMP;
    ...
    constexpr ObjectType ObjectType_MIN = OBJECT_IDLE;
    constexpr ObjectType ObjectType_MAX = OBJECT_BUTTON;
    ...
    enum StageNumber : int {
        STAGE_NULL = 0,
        STAGE_ONE = 1,
        STAGE_TWO = 2,
        STAGE_THREE = 3,
        StageNumber_INT_MIN_SENTINEL_DO_NOT_USE_ = std::numeric_limits<int32_t>::min(),
        StageNumber_INT_MAX_SENTINEL_DO_NOT_USE_ = std::numeric_limits<int32_t>::max()
    };
    bool StageNumber_IsValid(int value);
    constexpr StageNumber StageNumber_MIN = STAGE_NULL;
    constexpr StageNumber StageNumber_MAX = STAGE_THREE;
    constexpr int StageNumber_ARRAYSIZE = StageNumber_MAX + 1;

    const ::PROTOBUF_NAMESPACE_ID::EnumDescriptor* StageNumber_descriptor();
    template<typename T>
    inline const std::string& StageNumber_Name(T enum_t_value) {
        static_assert(::std::is_same<T, StageNumber>::value ||
            ::std::is_integral<T>::value,
            "Incorrect type passed to function StageNumber_Name.");
        return ::PROTOBUF_NAMESPACE_ID::internal::NameOfEnum(
            StageNumber_descriptor(), enum_t_value);
    }
    inline bool StageNumber_Parse(
        ::PROTOBUF_NAMESPACE_ID::ConstStringParam name, StageNumber* value) {
        return ::PROTOBUF_NAMESPACE_ID::internal::ParseNamedEnum<StageNumber>(
            StageNumber_descriptor(), name, value);
    }
    enum ActionType : int {
        LIGHT_ON = 0,
        DOOR_OPEN = 1,
    ...
    constexpr ActionType ActionType_MIN = LIGHT_ON;
    constexpr ActionType ActionType_MAX = DOOR_OPEN;
    ...
    enum ClickedItemType : int {
        KEY = 0,
        ClickedItemType_INT_MIN_SENTINEL_DO_NOT_USE_ = std::numeric_limits<int32_t>::min(),
        ClickedItemType_INT_MAX_SENTINEL_DO_NOT_USE_ = std::numeric_limits<int32_t>::max()
    };
    bool ClickedItemType_IsValid(int value);
    constexpr ClickedItemType ClickedItemType_MIN = KEY;
    constexpr ClickedItemType ClickedItemType_MAX = KEY;
    constexpr int ClickedItemType_ARRAYSIZE = ClickedItemType_MAX + 1;

    const ::PROTOBUF_NAMESPACE_ID::EnumDescriptor* ClickedItemType_descriptor();
    template<typename T>
    inline const std::string& ClickedItemType_Name(T enum_t_value) {
        static_assert(::std::is_same<T, ClickedItemType>::value ||
            ::std::is_integral<T>::value,
            "Incorrect type passed to function ClickedItemType_Name.");
        return ::PROTOBUF_NAMESPACE_ID::internal::NameOfEnum(
            ClickedItemType_descriptor(), enum_t_value);
    }
    inline bool ClickedItemType_Parse(
        ::PROTOBUF_NAMESPACE_ID::ConstStringParam name, ClickedItemType* value) {
        return ::PROTOBUF_NAMESPACE_ID::internal::ParseNamedEnum<ClickedItemType>(
            ClickedItemType_descriptor(), name, value);
    }
    // ===================================================================
...
template <> struct is_proto_enum< ::Protocol::StageNumber> : ::std::true_type {};
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::Protocol::StageNumber>() {
    return ::Protocol::StageNumber_descriptor();
}
template <> struct is_proto_enum< ::Protocol::ActionType> : ::std::true_type {};
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::Protocol::ActionType>() {
    return ::Protocol::ActionType_descriptor();
}
template <> struct is_proto_enum< ::Protocol::ClickedItemType> : ::std::true_type {};
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::Protocol::ClickedItemType>() {
    return ::Protocol::ClickedItemType_descriptor();
}
